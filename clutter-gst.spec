...
License  : LGPL-2.1
Requires: clutter-gst-lib
Requires: clutter-gst-doc
Requires: clutter-gst-data
...
export LANG=C
export SOURCE_DATE_EPOCH=1493738491
...
/usr/share/gtk-doc/html/clutter-gst-3.0/api-index-1-4.html
/usr/share/gtk-doc/html/clutter-gst-3.0/api-index-1-6.html
/usr/share/gtk-doc/html/clutter-gst-3.0/api-index-3-0.html
...
/usr/share/gtk-doc/html/clutter-gst-3.0/profile.txt
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/gstreamer-1.0/libgstclutter-3.0.so
/usr/lib64/libclutter-gst-3.0.so.0
/usr/lib64/libclutter-gst-3.0.so.0.24.0
